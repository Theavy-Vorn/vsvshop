    ...
    <div className="relative">
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium text-purple-500">
            <li>
              <Link
            ...
            <li>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 20 20"
                >
                  <path d="M10 2a4 4 0 11-8 0 4 4 0 018 0zM2 11a6 6 0 1112 0H2z" />
                </svg>
            ...
            <li>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 20 20"
                >
                  <path d="M10 2a2 2 0 00-2 2v2H4v2h4v2H4v2h4v2a2 2 0 002 2h6v-2h-6v-2h6v-2h-6v-2h6V6h-6V4a2 2 0 00-2-2z" />
                </svg>
